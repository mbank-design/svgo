...
exports.builtinValidate = [
  ...
  require('../pluginsValidate/hasCorrectStrokeColor.js'),
  require('../pluginsValidate/hasCorrectStripeColors.js'),
  require('../pluginsValidate/hasCorrectMaskColor.js'),
  ...
  require('../pluginsValidate/ensureSingleRootG.js'),
  require('../pluginsValidate/maxAndroidStringLength.js'),
];
