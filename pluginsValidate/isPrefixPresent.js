...
exports.fn = function (root, validateResult, params) {
  if (root.filename) {
    ...
    const themePrefixes = ['_retail', '_corporate', '_sme', '_mobile'];

    themePrefixes.push(assetType === 'logo' ? '_private' : '_private_banking');
    ...
    const isThemePrefix = themePrefixes.some((prefix) => {
